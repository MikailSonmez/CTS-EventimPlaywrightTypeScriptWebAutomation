...
- Name: e2e\profile.spec.ts >> User Profile Tests >> User can view profile page and see order history
- Location: tests\e2e\profile.spec.ts:18:7
...
Call log:
  - waiting for locator('[data-testid="email-input"]')
    ...
    - navigated to "https://next.eventim.de/?c=web&e=keykloak1108&ver=javascript-5.0.1&cver=1778762710&man=public-api.eventim.com%20keycloak%20%20&enqueuetoken=eyJ0eXAiOiJRVDEiLCJlbmMiOiJBRVMyNTYiLCJpc3MiOjE3Nzg4NTIyMjM…"
