...
- Name: api\user.api.spec.ts >> User Profile API Tests >> DELETE /user/profile - Should delete user account
- Location: tests\api\user.api.spec.ts:54:7
...
Call log:
  - → DELETE https://api-stg.example-eventim.com/v1/user/profile
