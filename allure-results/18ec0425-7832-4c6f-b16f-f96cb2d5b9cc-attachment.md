...
- Name: api\checkout.api.spec.ts >> Checkout API Flow Tests >> GET /checkout/:id/status - Should return checkout completion status
- Location: tests\api\checkout.api.spec.ts:56:7
...
Call log:
  - → GET https://api-stg.example-eventim.com/v1/checkout/3049061f-5963-469d-bb76-cb090754219b/status
