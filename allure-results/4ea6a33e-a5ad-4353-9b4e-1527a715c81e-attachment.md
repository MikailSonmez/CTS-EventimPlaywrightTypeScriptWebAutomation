...
- Name: api\search.api.spec.ts >> Search API Tests >> GET /search/events - Should filter events by location and date
- Location: tests\api\search.api.spec.ts:23:7
...
Call log:
  - → GET https://api-stg.example-eventim.com/v1/search/events?q=Festival&location=Berlin&dateFrom=2024-06-01&dateTo=2024-08-31
