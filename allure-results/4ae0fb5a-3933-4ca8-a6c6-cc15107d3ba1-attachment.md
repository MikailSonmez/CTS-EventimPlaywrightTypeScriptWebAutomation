...
- Name: regression\advanced-search.spec.ts >> Advanced Search & Filtering Regression >> Search with valid query returns at least one result
- Location: tests\regression\advanced-search.spec.ts:20:7
