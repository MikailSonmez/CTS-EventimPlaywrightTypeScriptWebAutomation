...
- Name: api\checkout.api.spec.ts >> Checkout API Flow Tests >> POST /checkout/initiate - Should create a checkout session
- Location: tests\api\checkout.api.spec.ts:17:7
...
Call log:
  - → POST https://api-stg.example-eventim.com/v1/checkout/initiate
