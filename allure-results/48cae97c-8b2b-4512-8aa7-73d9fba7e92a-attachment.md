...
- Name: e2e\localization.spec.ts >> Localization and Currency Tests >> User can change application language to German
- Location: tests\e2e\localization.spec.ts:13:7
