...
- Name: api\cart.api.spec.ts >> Cart API Tests >> POST /cart/items adds an item to the cart
- Location: tests\api\cart.api.spec.ts:19:7
...
Call log:
  - → POST https://api.example-eventim.com/v1/cart/items
