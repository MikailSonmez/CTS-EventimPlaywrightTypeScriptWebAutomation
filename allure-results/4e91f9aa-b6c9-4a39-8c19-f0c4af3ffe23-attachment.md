...
- Name: api\payment.api.spec.ts >> Payment API Tests >> POST /payment/methods - Should add a new credit card
- Location: tests\api\payment.api.spec.ts:23:7
...
Call log:
  - → POST https://api-stg.example-eventim.com/v1/payment/methods
