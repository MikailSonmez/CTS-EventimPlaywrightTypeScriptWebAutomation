...
- Name: regression\advanced-search.spec.ts >> Advanced Search & Filtering Regression >> Filter by price range works correctly
- Location: tests\regression\advanced-search.spec.ts:40:7
