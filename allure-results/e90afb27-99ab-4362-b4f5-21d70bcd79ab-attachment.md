...
- Name: api\user.api.spec.ts >> User Profile API Tests >> GET /user/profile - Should return 200 and user data
- Location: tests\api\user.api.spec.ts:15:7
...
Call log:
  - → GET https://api-stg.example-eventim.com/v1/user/profile
