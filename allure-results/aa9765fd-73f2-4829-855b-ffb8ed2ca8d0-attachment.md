...
- Name: api\checkout.api.spec.ts >> Checkout API Flow Tests >> POST /checkout/:id/promo - Should apply promo code
- Location: tests\api\checkout.api.spec.ts:27:7
...
Call log:
  - → POST https://api-stg.example-eventim.com/v1/checkout/779cae41-107b-46ce-b13d-09b776ea5d7b/promo
