...
- Name: api\search.api.spec.ts >> Search API Tests >> GET /search/artists - Should return artists matching query
- Location: tests\api\search.api.spec.ts:44:7
...
Call log:
  - → GET https://api-stg.example-eventim.com/v1/search/artists?q=Ed+Sheeran
