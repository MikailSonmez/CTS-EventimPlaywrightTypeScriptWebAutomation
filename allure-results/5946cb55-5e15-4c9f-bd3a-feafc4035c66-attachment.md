...
- Name: api\review.api.spec.ts >> Event Review API Tests >> POST /events/:id/reviews - Should allow user to submit a review
- Location: tests\api\review.api.spec.ts:25:7
...
Call log:
  - → POST https://api-stg.example-eventim.com/v1/events/3aece949-fd09-4033-86b3-991c443536ab/reviews
