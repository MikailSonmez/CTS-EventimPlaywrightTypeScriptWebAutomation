...
- Name: api\review.api.spec.ts >> Event Review API Tests >> GET /events/:id/reviews - Should return paginated reviews for event
- Location: tests\api\review.api.spec.ts:16:7
...
Call log:
  - → GET https://api-stg.example-eventim.com/v1/events/65b44aa2-aff7-4b4b-af33-5fbf9e29b5c4/reviews?page=1&limit=10
