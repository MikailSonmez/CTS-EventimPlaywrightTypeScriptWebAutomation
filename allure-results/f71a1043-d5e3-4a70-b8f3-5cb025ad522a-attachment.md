...
- Name: api\cart.api.spec.ts >> Cart API Tests >> DELETE /cart/items/:id removes an item from the cart
- Location: tests\api\cart.api.spec.ts:31:7

# Error details

```
Error: apiRequestContext.delete: getaddrinfo ENOTFOUND api.example-eventim.com
Call log:
  - → DELETE https://api.example-eventim.com/v1/cart/items/item_123
