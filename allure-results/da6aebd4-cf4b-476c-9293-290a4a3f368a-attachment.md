...
- Name: api\review.api.spec.ts >> Event Review API Tests >> POST /reviews/:id/like - Should allow user to like a review
- Location: tests\api\review.api.spec.ts:40:7
...
Call log:
  - → POST https://api-stg.example-eventim.com/v1/reviews/ed6a1e32-5f91-4759-8c38-2b04e6c46a34/like
