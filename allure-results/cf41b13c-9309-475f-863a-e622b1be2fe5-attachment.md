...
- Name: api\search.api.spec.ts >> Search API Tests >> GET /search/events - Should return events matching query
- Location: tests\api\search.api.spec.ts:14:7
...
Call log:
  - → GET https://api-stg.example-eventim.com/v1/search/events?q=Rock
