...
- Name: api\event.api.spec.ts >> Event API Tests >> GET /events returns list of events
- Location: tests\api\event.api.spec.ts:7:7
...
Call log:
  - → GET https://api.example-eventim.com/v1/events
