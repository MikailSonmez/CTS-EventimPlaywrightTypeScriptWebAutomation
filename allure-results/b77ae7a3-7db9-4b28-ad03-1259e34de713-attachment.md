...
- Name: api\user.api.spec.ts >> User Profile API Tests >> GET /user/orders - Should return list of past orders
- Location: tests\api\user.api.spec.ts:46:7
...
Call log:
  - → GET https://api-stg.example-eventim.com/v1/user/orders
