...
- Name: api\search.api.spec.ts >> Search API Tests >> GET /search/venues - Should return venues matching query
- Location: tests\api\search.api.spec.ts:52:7
...
Call log:
  - → GET https://api-stg.example-eventim.com/v1/search/venues?q=O2+Arena
