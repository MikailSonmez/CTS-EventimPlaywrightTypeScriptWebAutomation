...
- Name: api\payment.api.spec.ts >> Payment API Tests >> GET /payment/methods - Should list user payment methods
- Location: tests\api\payment.api.spec.ts:15:7
...
Call log:
  - → GET https://api-stg.example-eventim.com/v1/payment/methods
