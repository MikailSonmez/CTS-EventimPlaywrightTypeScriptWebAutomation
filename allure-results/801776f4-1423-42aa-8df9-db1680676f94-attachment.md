...
- Name: regression\advanced-search.spec.ts >> Advanced Search & Filtering Regression >> Filter by category works correctly
- Location: tests\regression\advanced-search.spec.ts:26:7
